...
public class TestUtils {
    ...
    public static final String BITGET_TEST_PHRASE = "yTest123321Test";
    ...
    public static final Signal lSignal = createTestSignal("SCRTUSDT");
    ...
    public static Signal createTestSignal(String pair) {
        ...
        signal.setTypeOreder(List.of("market", "0.1662"));
